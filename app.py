...
# Text Input
user_song_name = st.text_input('Enter a song name:')
st.write('You entered:', user_song_name)

user_artist_name = st.text_input('Enter the artist name:')
st.write('You entered:', user_artist_name)

# lowercase the input
song_name = user_song_name.lower()
artist_name = user_artist_name.lower()
...
if filtering_type == 'Content-Based Filtering':
    if st.button('Get Recommendations'):
        if ((songs_data["name"] == song_name) & (songs_data['artist'] == artist_name)).any():
            st.write('Recommendations for', f"**{user_song_name}** by **{user_artist_name}**")
            ...
            st.write(f"Sorry, we couldn't find {user_song_name} in our database. Please try another song.")
